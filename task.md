...
- [ ] 포켓몬 도메인(Pokemon) 특화 구현
    - [ ] `Pokemon` 엔티티 (도감번호, 이름, 속성, 지방 등) 구현
    - [ ] 전체 포켓몬 도감(바둑판 배열용) 목록 API 구현
    - [ ] 특정 포켓몬 ID 연관 판매 카드 목록 API 구현
- [ ] 카드 도감 도메인 구현
    - [ ] `CardMaster` 엔티티 구현 및 `Pokemon` 참조 연관관계 매핑 (`pokemon_id`)
    - [ ] 카드 도감 CRUD API 구현
    - [ ] 카드명 / 세트 / 카드번호 / 레어리티 구조 반영
    - [ ] 카드 썸네일/대표 이미지 관리
- [ ] 카드 검색 기능 구현
    - [ ] 카드명 검색
    - [ ] 세트별 검색
...
- [ ] 카드 추가 요청 기능 구현
    ...
    - [ ] 회원 카드 추가 요청 API 구현
    - [ ] 관리자 승인/반려 API 구현
    - [ ] 요청 상태 관리 (`PENDING`, `APPROVED`, `REJECTED`)
